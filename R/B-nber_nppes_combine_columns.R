...
# CLEANING FUNCTION at 2026 ----
# NPPES OB/GYN Provider Data Processing Script
# Requires: duckplyr, duckdb, DBI, logger, assertthat, janitor, lubridate,
#           tidyr, stringr, readr, forcats, dplyr, tibble, purrr, crayon
...
providers_with_mode_calculations <- providers_with_unified_dates %>%
  ...
  dplyr::compute() %>%
  dplyr::mutate(
    pcredential_mode_value = calculate_group_mode(pcredential),
...
# # CLEANING DATA Function at 0644

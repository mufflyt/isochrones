...
# Master figure directory setup - run this at the beginning
...
# Run this first
figures_dir <- setup_figure_directories("figures")
```
...
library(gganimate)
#' Create an animated plot showing access trends
#'
...
### Impact Narrative
```{r}
#' Calculate high level impact metrics
#'
#' @param data_path Path to CSV data
#' @return Tibble with impact metrics
#' @export
#' @import dplyr
#' @import readr
...
```{r}
#' Generate a narrative summarizing impact metrics
#'
#' @param data_path Path to CSV data
...
```{r, include = FALSE}
#' Generate results text with improved formatting
#'
#' @param data_path Path to CSV data
#' @return Character string of results
#' @export
...
#' @export
compare_accessibility_years <- function(accessibility_data_file = "access_by_group.csv",
                                      comparison_years = NULL,
...
#' @export
visualize_accessibility_trends_comprehensive <- function(accessibility_data_filepath = "access_by_group.csv", 
...
#' @importFrom stats sd
#' @export
compare_accessibility_between_years <- function(accessibility_data_filepath = "access_by_group.csv",
...
#' @export
run_comprehensive_accessibility_analysis <- function(accessibility_dataset_filepath = "access_by_group.csv",
...
hybrid_statistical_implementation <- function(accessibility_data_path = "access_by_group.csv",
  ...
  calculate_weighted_stats_with_ci <- function(values, weights, confidence_level = 0.95) {
...
```{r}
hybrid_statistical_implementation(accessibility_data_path = "data/Walker_data/access_by_group.csv",
                                            results_output_directory = getwd(),
                                            confidence_level = 0.95,
                                            apply_multiple_comparison_correction = TRUE,
                                            generate_publication_tables = TRUE,

...
#file_path <- "Desktop/2019_Physician_Compare_National_Downloadable_File_201912.csv"

file_path <- "/Volumes/Video Projects Muffly 1/nppes_historical_downloads/unzipped_p_files/npidata_pfile_20050523-20180708.csv"

# Read only the first row to get column names
data_preview <- read_csv(file_path, n_max = 1)
View(data_preview)
...
nppes_table <- dplyr::tbl(db_connection, "2022_full")
